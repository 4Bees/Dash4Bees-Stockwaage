...
// DHT Sensor output pin connected to Dash GPIO#define DHTTYPE DHT22
// DHT 22//Change this to change how often the DHT22 data is printed and sent to the cloud
...
scale.power_up();
SerialCloud.println(dhtJSON());
// Send JSON DHT data to Hologram Cloud
scale.power_down();
